...
function __init__()
    ...
    H5P_OBJECT_CREATE[]    = unsafe_load(cglobal((:H5P_CLS_OBJECT_CREATE_ID_g, libhdf5), hid_t))
    H5P_FILE_CREATE[]      = unsafe_load(cglobal((:H5P_CLS_FILE_CREATE_ID_g, libhdf5), hid_t))
    H5P_FILE_ACCESS[]      = unsafe_load(cglobal((:H5P_CLS_FILE_ACCESS_ID_g, libhdf5), hid_t))
    H5P_DATASET_CREATE[]   = unsafe_load(cglobal((:H5P_CLS_DATASET_CREATE_ID_g, libhdf5), hid_t))
    H5P_DATASET_ACCESS[]   = unsafe_load(cglobal((:H5P_CLS_DATASET_ACCESS_ID_g, libhdf5), hid_t))
    H5P_DATASET_XFER[]     = unsafe_load(cglobal((:H5P_CLS_DATASET_XFER_ID_g, libhdf5), hid_t))
    H5P_FILE_MOUNT[]       = unsafe_load(cglobal((:H5P_CLS_FILE_MOUNT_ID_g, libhdf5), hid_t))
    H5P_GROUP_CREATE[]     = unsafe_load(cglobal((:H5P_CLS_GROUP_CREATE_ID_g, libhdf5), hid_t))
    H5P_GROUP_ACCESS[]     = unsafe_load(cglobal((:H5P_CLS_GROUP_ACCESS_ID_g, libhdf5), hid_t))
    H5P_DATATYPE_CREATE[]  = unsafe_load(cglobal((:H5P_CLS_DATATYPE_CREATE_ID_g, libhdf5), hid_t))
    H5P_DATATYPE_ACCESS[]  = unsafe_load(cglobal((:H5P_CLS_DATATYPE_ACCESS_ID_g, libhdf5), hid_t))
    H5P_STRING_CREATE[]    = unsafe_load(cglobal((:H5P_CLS_STRING_CREATE_ID_g, libhdf5), hid_t))
    H5P_ATTRIBUTE_CREATE[] = unsafe_load(cglobal((:H5P_CLS_ATTRIBUTE_CREATE_ID_g, libhdf5), hid_t))
    H5P_OBJECT_COPY[]      = unsafe_load(cglobal((:H5P_CLS_OBJECT_COPY_ID_g, libhdf5), hid_t))
    H5P_LINK_CREATE[]      = unsafe_load(cglobal((:H5P_CLS_LINK_CREATE_ID_g, libhdf5), hid_t))
    H5P_LINK_ACCESS[]      = unsafe_load(cglobal((:H5P_CLS_LINK_ACCESS_ID_g, libhdf5), hid_t))

    # Type_id constants (LE = little endian, I16 = Int16, etc)
    H5T_STD_I8LE[]        = unsafe_load(cglobal((:H5T_STD_I8LE_g, libhdf5), hid_t))
    H5T_STD_I8BE[]        = unsafe_load(cglobal((:H5T_STD_I8BE_g, libhdf5), hid_t))
    H5T_STD_U8LE[]        = unsafe_load(cglobal((:H5T_STD_U8LE_g, libhdf5), hid_t))
    H5T_STD_U8BE[]        = unsafe_load(cglobal((:H5T_STD_U8BE_g, libhdf5), hid_t))
    H5T_STD_I16LE[]       = unsafe_load(cglobal((:H5T_STD_I16LE_g, libhdf5), hid_t))
    H5T_STD_I16BE[]       = unsafe_load(cglobal((:H5T_STD_I16BE_g, libhdf5), hid_t))
    H5T_STD_U16LE[]       = unsafe_load(cglobal((:H5T_STD_U16LE_g, libhdf5), hid_t))
    H5T_STD_U16BE[]       = unsafe_load(cglobal((:H5T_STD_U16BE_g, libhdf5), hid_t))
    H5T_STD_I32LE[]       = unsafe_load(cglobal((:H5T_STD_I32LE_g, libhdf5), hid_t))
    H5T_STD_I32BE[]       = unsafe_load(cglobal((:H5T_STD_I32BE_g, libhdf5), hid_t))
    H5T_STD_U32LE[]       = unsafe_load(cglobal((:H5T_STD_U32LE_g, libhdf5), hid_t))
    H5T_STD_U32BE[]       = unsafe_load(cglobal((:H5T_STD_U32BE_g, libhdf5), hid_t))
    H5T_STD_I64LE[]       = unsafe_load(cglobal((:H5T_STD_I64LE_g, libhdf5), hid_t))
    H5T_STD_I64BE[]       = unsafe_load(cglobal((:H5T_STD_I64BE_g, libhdf5), hid_t))
    H5T_STD_U64LE[]       = unsafe_load(cglobal((:H5T_STD_U64LE_g, libhdf5), hid_t))
    H5T_STD_U64BE[]       = unsafe_load(cglobal((:H5T_STD_U64BE_g, libhdf5), hid_t))
    H5T_IEEE_F32LE[]      = unsafe_load(cglobal((:H5T_IEEE_F32LE_g, libhdf5), hid_t))
    H5T_IEEE_F32BE[]      = unsafe_load(cglobal((:H5T_IEEE_F32BE_g, libhdf5), hid_t))
    H5T_IEEE_F64LE[]      = unsafe_load(cglobal((:H5T_IEEE_F64LE_g, libhdf5), hid_t))
    H5T_IEEE_F64BE[]      = unsafe_load(cglobal((:H5T_IEEE_F64BE_g, libhdf5), hid_t))
    H5T_C_S1[]            = unsafe_load(cglobal((:H5T_C_S1_g, libhdf5), hid_t))
    H5T_STD_REF_OBJ[]     = unsafe_load(cglobal((:H5T_STD_REF_OBJ_g, libhdf5), hid_t))
    H5T_STD_REF_DSETREG[] = unsafe_load(cglobal((:H5T_STD_REF_DSETREG_g, libhdf5), hid_t))

    # Native types
    H5T_NATIVE_B8[]       = unsafe_load(cglobal((:H5T_NATIVE_B8_g, libhdf5), hid_t))
    H5T_NATIVE_INT8[]     = unsafe_load(cglobal((:H5T_NATIVE_INT8_g, libhdf5), hid_t))
    H5T_NATIVE_UINT8[]    = unsafe_load(cglobal((:H5T_NATIVE_UINT8_g, libhdf5), hid_t))
    H5T_NATIVE_INT16[]    = unsafe_load(cglobal((:H5T_NATIVE_INT16_g, libhdf5), hid_t))
    H5T_NATIVE_UINT16[]   = unsafe_load(cglobal((:H5T_NATIVE_UINT16_g, libhdf5), hid_t))
    H5T_NATIVE_INT32[]    = unsafe_load(cglobal((:H5T_NATIVE_INT32_g, libhdf5), hid_t))
    H5T_NATIVE_UINT32[]   = unsafe_load(cglobal((:H5T_NATIVE_UINT32_g, libhdf5), hid_t))
    H5T_NATIVE_INT64[]    = unsafe_load(cglobal((:H5T_NATIVE_INT64_g, libhdf5), hid_t))
    H5T_NATIVE_UINT64[]   = unsafe_load(cglobal((:H5T_NATIVE_UINT64_g, libhdf5), hid_t))
    H5T_NATIVE_FLOAT[]    = unsafe_load(cglobal((:H5T_NATIVE_FLOAT_g, libhdf5), hid_t))
    H5T_NATIVE_DOUBLE[]   = unsafe_load(cglobal((:H5T_NATIVE_DOUBLE_g, libhdf5), hid_t))
