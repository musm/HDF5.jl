...
const H5P_OBJECT_CREATE    = Ref{Hid}()
const H5P_FILE_CREATE      = Ref{Hid}()
const H5P_FILE_ACCESS      = Ref{Hid}()
const H5P_DATASET_CREATE   = Ref{Hid}()
const H5P_DATASET_ACCESS   = Ref{Hid}()
const H5P_DATASET_XFER     = Ref{Hid}()
const H5P_FILE_MOUNT       = Ref{Hid}()
const H5P_GROUP_CREATE     = Ref{Hid}()
const H5P_GROUP_ACCESS     = Ref{Hid}()
const H5P_DATATYPE_CREATE  = Ref{Hid}()
const H5P_DATATYPE_ACCESS  = Ref{Hid}()
const H5P_STRING_CREATE    = Ref{Hid}()
const H5P_ATTRIBUTE_CREATE = Ref{Hid}()
const H5P_OBJECT_COPY      = Ref{Hid}()
const H5P_LINK_CREATE      = Ref{Hid}()
const H5P_LINK_ACCESS      = Ref{Hid}()
...
const H5T_STD_I8LE        = Ref{Hid}()
const H5T_STD_I8BE        = Ref{Hid}()
const H5T_STD_U8LE        = Ref{Hid}()
const H5T_STD_U8BE        = Ref{Hid}()
const H5T_STD_I16LE       = Ref{Hid}()
const H5T_STD_I16BE       = Ref{Hid}()
const H5T_STD_U16LE       = Ref{Hid}()
const H5T_STD_U16BE       = Ref{Hid}()
const H5T_STD_I32LE       = Ref{Hid}()
const H5T_STD_I32BE       = Ref{Hid}()
const H5T_STD_U32LE       = Ref{Hid}()
const H5T_STD_U32BE       = Ref{Hid}()
const H5T_STD_I64LE       = Ref{Hid}()
const H5T_STD_I64BE       = Ref{Hid}()
const H5T_STD_U64LE       = Ref{Hid}()
const H5T_STD_U64BE       = Ref{Hid}()
const H5T_IEEE_F32LE      = Ref{Hid}()
const H5T_IEEE_F32BE      = Ref{Hid}()
const H5T_IEEE_F64LE      = Ref{Hid}()
const H5T_IEEE_F64BE      = Ref{Hid}()
const H5T_C_S1            = Ref{Hid}()
const H5T_STD_REF_OBJ     = Ref{Hid}()
const H5T_STD_REF_DSETREG = Ref{Hid}()
# Native types
const H5T_NATIVE_B8       = Ref{Hid}()
const H5T_NATIVE_INT8     = Ref{Hid}()
const H5T_NATIVE_UINT8    = Ref{Hid}()
const H5T_NATIVE_INT16    = Ref{Hid}()
const H5T_NATIVE_UINT16   = Ref{Hid}()
const H5T_NATIVE_INT32    = Ref{Hid}()
const H5T_NATIVE_UINT32   = Ref{Hid}()
const H5T_NATIVE_INT64    = Ref{Hid}()
const H5T_NATIVE_UINT64   = Ref{Hid}()
const H5T_NATIVE_FLOAT    = Ref{Hid}()
const H5T_NATIVE_DOUBLE   = Ref{Hid}()
