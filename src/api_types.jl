...
const H5P_OBJECT_CREATE    = Ref{hid_t}()
const H5P_FILE_CREATE      = Ref{hid_t}()
const H5P_FILE_ACCESS      = Ref{hid_t}()
const H5P_DATASET_CREATE   = Ref{hid_t}()
const H5P_DATASET_ACCESS   = Ref{hid_t}()
const H5P_DATASET_XFER     = Ref{hid_t}()
const H5P_FILE_MOUNT       = Ref{hid_t}()
const H5P_GROUP_CREATE     = Ref{hid_t}()
const H5P_GROUP_ACCESS     = Ref{hid_t}()
const H5P_DATATYPE_CREATE  = Ref{hid_t}()
const H5P_DATATYPE_ACCESS  = Ref{hid_t}()
const H5P_STRING_CREATE    = Ref{hid_t}()
const H5P_ATTRIBUTE_CREATE = Ref{hid_t}()
const H5P_OBJECT_COPY      = Ref{hid_t}()
const H5P_LINK_CREATE      = Ref{hid_t}()
const H5P_LINK_ACCESS      = Ref{hid_t}()
...
const H5T_STD_I8LE        = Ref{hid_t}()
const H5T_STD_I8BE        = Ref{hid_t}()
const H5T_STD_U8LE        = Ref{hid_t}()
const H5T_STD_U8BE        = Ref{hid_t}()
const H5T_STD_I16LE       = Ref{hid_t}()
const H5T_STD_I16BE       = Ref{hid_t}()
const H5T_STD_U16LE       = Ref{hid_t}()
const H5T_STD_U16BE       = Ref{hid_t}()
const H5T_STD_I32LE       = Ref{hid_t}()
const H5T_STD_I32BE       = Ref{hid_t}()
const H5T_STD_U32LE       = Ref{hid_t}()
const H5T_STD_U32BE       = Ref{hid_t}()
const H5T_STD_I64LE       = Ref{hid_t}()
const H5T_STD_I64BE       = Ref{hid_t}()
const H5T_STD_U64LE       = Ref{hid_t}()
const H5T_STD_U64BE       = Ref{hid_t}()
const H5T_IEEE_F32LE      = Ref{hid_t}()
const H5T_IEEE_F32BE      = Ref{hid_t}()
const H5T_IEEE_F64LE      = Ref{hid_t}()
const H5T_IEEE_F64BE      = Ref{hid_t}()
const H5T_C_S1            = Ref{hid_t}()
const H5T_STD_REF_OBJ     = Ref{hid_t}()
const H5T_STD_REF_DSETREG = Ref{hid_t}()
# Native types
const H5T_NATIVE_B8       = Ref{hid_t}()
const H5T_NATIVE_INT8     = Ref{hid_t}()
const H5T_NATIVE_UINT8    = Ref{hid_t}()
const H5T_NATIVE_INT16    = Ref{hid_t}()
const H5T_NATIVE_UINT16   = Ref{hid_t}()
const H5T_NATIVE_INT32    = Ref{hid_t}()
const H5T_NATIVE_UINT32   = Ref{hid_t}()
const H5T_NATIVE_INT64    = Ref{hid_t}()
const H5T_NATIVE_UINT64   = Ref{hid_t}()
const H5T_NATIVE_FLOAT    = Ref{hid_t}()
const H5T_NATIVE_DOUBLE   = Ref{hid_t}()
